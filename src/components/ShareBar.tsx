...
/** Savršeni krug + blagi hover zoom */
const btnCircle =
    ...
    <div className="flex items-center gap-2">
      ...
      {hasNativeShare && (
        <button
          ...
          className={`${btnCircle} bg-emerald-600 text-white hover:bg-emerald-500`}
          title="Podijeli"
          aria-label="Podijeli"
        >
      ...
      <button
        type="button"
        onClick={handleCopy}
        className={`${btnCircle} bg-gray-800 text-slate-100 hover:bg-gray-700`}
      ...
      <button
        ...
        className={`${btnCircle} bg-[#1877F2] text-sm font-bold lowercase text-white`}
        title="Facebook"
        aria-label="Facebook"
      >
        fb
      ...
      <button
        ...
        className={`${btnCircle} bg-black text-white`}
        title="X"
        aria-label="X"
      >
        <XLogo />
      ...
      <button
        ...
        className={`${btnCircle} bg-[#0A66C2] text-white`}
        title="LinkedIn"
        aria-label="LinkedIn"
      >
        <LinkedInLogo />
